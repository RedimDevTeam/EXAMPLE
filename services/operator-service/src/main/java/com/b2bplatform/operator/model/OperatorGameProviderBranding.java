...
/**
 * Entity for game provider branding assets per operator.
 */
@Entity
@Table(name = "operator_game_provider_branding",
       uniqueConstraints = @UniqueConstraint(columnNames = {"operator_id", "game_provider_id", "logo_type", "display_order"}))
@Data
public class OperatorGameProviderBranding {
